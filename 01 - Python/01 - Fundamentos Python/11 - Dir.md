...
O método ``dir()`` devolve todas as propriedades e métodos disponíveis do objecto especificado:
...
'bit_count', 'bit_length', 'conjugate', 'denominator', 'from_bytes', 'imag', 'numerator', 
'real', 'to_bytes']
"""

# No escopo global irá mostrar também as variáveis criadas que estão no escopo global
